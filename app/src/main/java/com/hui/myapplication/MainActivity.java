...
import com.hui.myapplication.utils.BudgetDialog;
import com.hui.myapplication.utils.MoreDialog;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    SharedPreferences preferences;    //点击获取的时候显示数据
        ...
        builder.setTitle("提示信息").setMessage("您确定要删除这条记录吗？")
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        setTopShow();       //2.1.12   改变头布局Text View显示的内容
                    }
                });
    ...
    protected void onResume() {
        super.onResume();
        loadDBData();
        setTopShow();       //设置头布局当中文本内容的显示
    }

    //设置头布局当中文本内容的显示
    private void setTopShow() {
        //获取今日支出和收入总金额，显示再view当中
        ...
        //显示运算剩余
        float bmoney = preferences.getFloat("bmoney",0);  //预算bmoney
        if (bmoney == 0) {
            topbudgetTv.setText("￥ 0");
        }else {
            float syMoney = bmoney - outcomeOneMonth;       //剩余symoney
