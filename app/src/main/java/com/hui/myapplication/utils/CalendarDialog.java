...
import com.hui.myapplication.adapter.CalendarAdapter;
...
public class CalendarDialog extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //设置GridView当中每一个item的点击事件2.6.35
        setGVLintener();
    }

    private void setGVLintener() {
    ...
    //给横向的ScrollView的每一个TextView设置点击事件
